...
//| - Close above/below candle buffer high/low (APPLIED)             |
//|                                                                  |
//+------------------------------------------------------------------+
...
string GetTrendFollowingSignal()
{
  ...
  if(LastCandleColor == "bull")
  {
    ...
    int HighestIndex = iHighest(Symbol(),Timeframe,MODE_HIGH,BufferCandles,2);
  ...
  else if(LastCandleColor == "bear")
  {
    ...
    int LowestIndex = iLowest(Symbol(),Timeframe,MODE_LOW,BufferCandles,2);
