//+------------------------------------------------------------------+
//|                                            v3.2TrendFollowing.mq5|
//|                                              Jasper Niittyvuopio |
//|                                             https://www.mql5.com |
//|                                                                  |
//| Changes being implemented (compared to previous version):        | 
//|                                                                  |
//| - Fixed stop loss in absolute value (APPLIED)                    |
//| - Disable trading during summer months (APPLIED)                 |
//| - Disable trading during market close (APPLIED)                  |
//|                                                                  |
//+------------------------------------------------------------------+
...
input int TradeBanStart = 7; //Trading disabled first month (1-12)
input int TradeBanEnd = 8; //Trading disabled last month (1-12)
...
void OnTick()
  ...
  if(time.mon < TradeBanStart || time.mon > TradeBanEnd)
  {
